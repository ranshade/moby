...
function getDeploymentDomain() {
  ...
  console.error(
    'ERROR: No deployment domain found. Set EXPO_PUBLIC_DOMAIN to the host that will serve this static build (e.g. app.example.com).',
  );
  process.exit(1);
}
...
async function startMetro(expoPublicDomain) {
  ...
  // Other EXPO_PUBLIC_* values (Clerk key, API URL) come from your shell or .env.
  const env = {
    ...process.env,
